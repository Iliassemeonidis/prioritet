...
//        sleep(1000);
//        $("#organizationId").setValue("ПАО \"Россети\"");
////        sleep(1000);
////        $(byText("ПАО \"Россети\"")).click();
//
//        $(".resolutions-node-container").shouldBe(visible);
//    }
//
//    @Test
...
//        $$(".resolutions-node-container").shouldHaveSize(2);
//    }
//
//    @Test
...
//        $(".resolutions-node-container").find(byText(AUTOTEST_NAME2)).shouldBe(visible);
//
//        $(".delete").click();
//
...
//        sleep(1000);
//        $(".resolutions-node-container").find(byText(AUTOTEST_NAME3)).shouldBe(visible);
//        $(".delete").click();
//
//    }
//
...
//        sleep(10000);
//
//        //$(byText("На резолюцию")).shouldBe(visible);
//    }
...
//        Random rd = new Random();
//        // рег номер
//        $("#dss_reg_number").setValue(String.valueOf(rd.nextInt(999) + 12));
//
//        // дата регистрации
...
//    /////////////////// Договор (Волс)
    ...
    public void test_353() {
        ...
        sleep(1000);
        $(byText("Краткое содержание")).scrollIntoView(true);
        $("div.input-container:nth-child(8) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > input:nth-child(1)").setValue("Auto-test777");
        sleep(1000);
        Buttons.search();
        sleep(20000);
        $("div.tr:nth-child(1) > div:nth-child(2) > div:nth-child(1)").click();
        sleep(10000);
        $$(byText("Связать")).first().click();
        sleep(10000);
...
//    ////////////// ДОКУМЕНТЫ ОРГАНОВ УПРАВЛЕНИЯ(протокол)
    ...
    public void test_416() {
        CreateDocument.create("ДОКУМЕНТЫ ОРГАНОВ УПРАВЛЕНИЯ");
        Buttons.content();
        Content.contentUpload(ORDER_DOC);
        sleep(1000);
...
//secretar
        $("#dsid_secretary_empl").setValue(AUTOTEST_NAME3);
        sleep(1000);
        $(byText(AUTOTEST3)).click();
    }
